...
package com.yingwo.yingwo.configs;
...
import com.yingwo.yingwo.instrumentation.InstrumentedDraweeView;
...
//			  .setResizeOptions(new ResizeOptions(view.getLayoutParams().width, view.getLayoutParams().height))//调整大小
			  .setSource(Uri.parse(uri))//设置图片地址
			  .build();
	  return imageRequest;
  }
...
public static void init(final Resources resources) {
	    if (sPlaceholderDrawable == null) {
	      sPlaceholderDrawable = resources.getDrawable(R.color.white);
	    }
	    if (sErrorDrawable == null) {
	      sErrorDrawable = resources.getDrawable(R.color.white);
	    }
	  }
