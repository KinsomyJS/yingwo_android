...
public class PostBuildingActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        Toast.makeText(this, "post_id:" + post_id, Toast.LENGTH_SHORT).show();
        ...
        photoEditListAdapter = new PhotoEditListAdapter(PostBuildingActivity.this, mPhotoList);
    ...
    private GalleryFinal.OnHanlderResultCallback mOnHanlderResultCallback = new GalleryFinal.OnHanlderResultCallback() {
        ...
        public void onHanlderFailure(int requestCode, String errorMsg) {
            Toast.makeText(PostBuildingActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
        }
    };
...
//            urls = "";
    ...
    public void deleteIndex(final int position, PhotoInfo photoInfo) {
        new AlertDialog.Builder(PostBuildingActivity.this).setTitle("删除提示")
                .setMessage("删除图片")
    ...
    public void post_Building(int post_id, String img_url, String content) {
        ...
        userinfoService.build_reply(post_id, img_url, content)
