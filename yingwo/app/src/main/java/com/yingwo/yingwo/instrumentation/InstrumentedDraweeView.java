...
package com.yingwo.yingwo.instrumentation;
...
import com.yingwo.yingwo.configs.ConfigConstants;
...
public class InstrumentedDraweeView extends SimpleDraweeView implements Instrumented {
	...
	public void setImageURI(Uri uri, @Nullable Object callerContext) {
		SimpleDraweeControllerBuilder controllerBuilder = ConfigConstants.getSimpleDraweeControllerBuilder(getControllerBuilder(),uri,callerContext,getController());
